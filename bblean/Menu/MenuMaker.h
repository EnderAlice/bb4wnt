...
int  MenuMaker_LoadFolder(MenuItem **, const struct _ITEMIDLIST *pIDFolder, const TCHAR  *optional_command);
...
void MenuItemInt_SetOffValue(MenuItem *, int, const TCHAR*);
...
void exec_cfg_command(const TCHAR *pszCommand);
const void *exec_internal_broam(const TCHAR *argument, const struct cfgmenu *menu_root, const struct cfgmenu **p_menu, const struct cfgmenu **p_item);
