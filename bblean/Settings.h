...
BBSETTING TCHAR Settings_toolbarPlacement[20];
BBSETTING int Settings_toolbarWidthPercent;
BBSETTING TCHAR Settings_toolbarStrftimeFormat[40];
...
BBSETTING TCHAR Settings_menuBulletPosition_cfg[16];
...
BBSETTING TCHAR Settings_workspaceNames[256];
...
BBSETTING TCHAR Settings_recentMenu[MAX_PATH];
...
BBSETTING TCHAR Settings_separatorStyle[12];
...
//BBSETTING TCHAR Settings_windowPlacement[80];
//BBSETTING TCHAR Settings_colPlacementDirection[80];
//BBSETTING TCHAR Settings_rowPlacementDirection[80];
