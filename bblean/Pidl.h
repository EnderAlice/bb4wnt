...
_ITEMIDLIST * get_folder_pidl(const TCHAR *path);
...
TCHAR *replace_shellfolders(TCHAR *buffer, const TCHAR *path, bool search_path);
...
#define NextID(pidl) ((_ITEMIDLIST*)((BYTE*)pidl+pidl->mkid.cb))
