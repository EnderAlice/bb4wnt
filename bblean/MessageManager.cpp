...
//===========================================================================
#if 0
void dbg_msg(const TCHAR *id, HWND window, UINT msg)
{
	TCHAR buffer[256];
	GetClassName(window, buffer, 256);
	dbg_printf(_T("%s: %s %d"), id, buffer, msg);
}
#else
...
//===========================================================================
void AddRemoveMessages(HWND window, UINT* messages, bool add)
{
	UINT msg;
