...
struct plugins
{
    struct plugins *next;
    HMODULE hmodule;
    const TCHAR* (*pluginInfo)(int);
    int (API_CALL *beginPlugin)(HINSTANCE);
    int (API_CALL *endPlugin)(HINSTANCE);
    int (API_CALL *beginSlitPlugin)(HINSTANCE, HWND);
    int (API_CALL *beginPluginEx)(HINSTANCE, HWND);
    bool is_comment;
    bool is_slit;
    bool enabled;
    bool useslit;
